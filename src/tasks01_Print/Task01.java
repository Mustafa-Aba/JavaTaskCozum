...
public class Task01 {
    ...
    public static void main(String[] args) {
        ...
        //Soru-4 : "Basari" gayreti 'sever'  yazdırınız sonra "Clarusway ile java cok kolay ..." ifadesi  3 satır sonra ve satır basından 1 tab ileride yazılsın.
