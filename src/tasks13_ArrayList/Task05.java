...
public class Task05 {
    ...
    public static void main(String[] args) {
        ...
        Ex : Input : {{Ali,Veli,Ayse},{Hasan,Can},{Suzan}}//[ali,veli,ayse,hasan..]
    ...
    private static ArrayList<String> sortListByAlphabetically(String[][] multiArray) {
        ...
        while (i < names.size()-1 ) {
            ...
            //elemanların harf sayısı karşılaştırıldı.küçük olan sınır yapıldı.
            for (int k = 0; k < minUzunluk; k++) {
                if (names.get(i).toLowerCase().charAt(k) > names.get(i + 1).toLowerCase().charAt(k)) {
                    //sonraki eleman önceki elemandan sonra geliyorsa yer değiştir.
